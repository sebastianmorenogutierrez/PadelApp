...
public class TorneoController {
    ...
    // 🏆 MÉTODO CORREGIDO: AÑADIDA LÓGICA DE SEGURIDAD (Se usa en el formulario de edición)
    ...
    public String editarTorneo(@PathVariable Long id, Model model) {
        ...
        // 1. Obtener usuario actual y estado de administración
        ...
        return "formulario_torneo"; // Retorna al formulario de edición
    }
    ...
    // 🏆 MÉTODO CORREGIDO 1: Agregando la verificación 'yaInscrito' (Vista de detalle)
    @GetMapping("/{id}")
    public String verTorneo(@PathVariable Long id, Model model) {
        ...
        // 🏆 Lógica de verificación de inscripción
    ...
    // 🏆 MÉTODO CORREGIDO 2: Obtiene el Usuario logueado y maneja excepciones (Inscripción)
    @PostMapping("/{id}/inscribir")
    public String inscribir(@PathVariable Long id, Model model) {
        try {
            Usuario usuarioActual = usuarioServicio.obtenerUsuarioActual();
    ...
    // El método anterior 'inscribir' reemplaza completamente este método antiguo y obsoleto:
    /*
    @PostMapping("/{id}/inscribir")
